...
<div class="content-wrapper">
    ...
    <section class="wrapper bg-soft-primary mb-3">
        <div class="container pt-14 pb-14 pt-md-16 pb-md-20">
            <div class="row align-items-center mb-10">
                <div class="col-md-12 pe-xl-20">
                    <h2 class="display-4 mb-3">Our Services</h2>
                    <p class="lead fs-20 mb-0">We are a creative company that focuses on establishing long-term
                            ...
                            <div class="card image-wrapper bg-full bg-image bg-overlay bg-overlay-400 text-white mt-n5 mt-lg-0 mt-lg-n50p mb-lg-n50p border-radius-lg-top"
                                ...
                                <div class="card-body p-9 p-xl-10">
                                    <div class="row align-items-center counter-wrapper gy-4 text-center">
                                        ...
                                        <!--/column -->
                                        <div class="col-6 col-lg-3">
                                            <h3 class="counter counter-lg text-white">1350</h3>
                                        ...
                                        <!--/column -->
                                        <div class="col-6 col-lg-3">
                                            <h3 class="counter counter-lg text-white">75</h3>
                                            <p>Awards Won</p>
                                        </div>
                                        <!--/column -->
                                    </div>
    ...
    <section class="wrapper">
        <div class="container pb-14 pb-md-16">
            <div class="row text-center">
                <div class="col-xl-10 mx-auto">
                    <h3 class="display-4 mb-10 px-xxl-15">We’re always there for amazing people to get our
                        services. Take a look at our current services.</h3>
                </div>
                <!-- /column -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-md-6 col-lg-4">
                    <a href="#" class="card shadow-lg lift h-100">
                        <div class="card-body p-5 d-flex flex-row">
                            <div>
                                <span class="avatar bg-red text-white w-11 h-11 fs-20 me-8">SD</span>
                            </div>
                            <div>
            ...
            <div class="row mt-11">
                <div class="col-lg-6 col-xl-5 mx-auto text-center">
                    <h2 class="display-6 mb-3">Can't find the right Company?</h2>
                    <p class="lead mb-5 px-md-16 px-lg-3">Cras justo odio, dapibus ac facilisis in, egestas
                        eget quam. Morbi leo risus, porta ac consectetur.</p>
                    <a href="contact.php" class="btn btn-primary rounded-pill">Get in Touch</a>
                </div>
                <!-- /column -->
            </div>
            <!-- /.row -->
