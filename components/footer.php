      ...
      <div class="col-xl-11 col-xxl-10 mx-auto">
        <div class="card image-wrapper bg-full bg-image bg-overlay bg-overlay-400 mt-n50p mb-n5" data-image-src="./assets/img/photos/bg3.jpg">
          <div class="card-body p-6 p-md-11 d-lg-flex flex-row align-items-lg-center justify-content-md-between text-center text-lg-start">
            ...
            <a href="contact.php" class="btn btn-white rounded-pill mb-0 text-nowrap">Contact Us</a>
          </div>
          <!--/.card-body -->
        </div>
        <!--/.card -->
  ...
  <div class="container pb-12 text-center">
    <div class="row mt-n10 mt-lg-0">
      <div class="col-xl-10 mx-auto">
        <div class="row mb-3">
          ...
          <div class="col-md-4">
            <div class="widget">
              ...
              <p><a href="mailto:support@nihaswisolutions.com" class="link-body">support@nihaswisolutions.com</a></p>
            </div>
            <!-- /.widget -->
          </div>
          <!--/column -->
        ...
        <!--/.row -->
        <p>© 2023 Nihaswi Solutions. All Rights Reserved.</p>
